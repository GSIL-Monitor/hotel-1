...
public interface AgentInvoiceItemMapper extends MyMapper<AgentInvoiceItemDO> {
     ...
     * @return
     */
    public int deleteAgentInvoiceItem(DeleteInvoiceItemDTO request);
     ...
     * @return
     */
    public List<InvoiceItemDTO> queryAgentInvoiceItem(QueryInvoiceItemDTO request);
     ...
     * @return
     */
    public List<UnInvoiceOrderDTO> queryUnInvoiceOrder(QueryUnInvoiceOrderDTO request);
     ...
     * @return
     */
    public List<UnInvoiceBillDTO> queryUnInvoiceAgentBill(QueryUnInvoiceBillDTO request);
}