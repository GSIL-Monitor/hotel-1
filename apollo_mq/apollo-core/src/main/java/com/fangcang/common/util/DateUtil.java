...
public class DateUtil {
    ...
    /**
     * 带时分秒格式 yyyy-MM-dd HH:mm:ss
     */
    public static String HH_MM_SS_FORMAT = "yyyy-MM-dd HH:mm:ss";
    ...
    /**
     * 将字符串转换为日期 (带时分秒格式 yyyy-MM-dd HH:mm:ss)
     *
     * @param date
     * @return
     * @throws ParseException
     */
    public static Date stringToDateWithHms(String date) {
        return stringToDate(date, HH_MM_SS_FORMAT);
    }
    ...
    /**
     * 将日期转换为字符串 (带时分秒格式 yyyy-MM-dd HH:mm:ss)
     *
     * @param date
     * @return
     */
    public static String dateToStringWithHms(Date date) {
        return dateToString(date, HH_MM_SS_FORMAT);
    }
